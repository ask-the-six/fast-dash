...
# Sample Dataframealnoda_registry_explorer/
...
def update_form_from_intermediate(jsonified_selected_data):
    selected_data = json.loads(jsonified_selected_data)
    return tuple(selected_data[field] for field in fields)


# Run the Dash app
if __name__ == '__main__':
    app.run_server(debug=True, port='8675')